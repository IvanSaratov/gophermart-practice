...
// Собирает HTTP-маршруты и middleware операционного API.
func NewRouter(logger *zap.Logger, metrics *observability.Metrics, readiness ReadinessCheck) http.Handler {
